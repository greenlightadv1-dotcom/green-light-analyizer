...
export function ExpiryWarningBanner({ profile }: { profile: Profile }) {
  ...
  return (
    <div className="mb-4 flex flex-wrap items-center justify-between gap-3 rounded-xl border border-amber-300/25 bg-amber-300/10 px-4 py-2.5 text-xs leading-relaxed text-amber-100">
      <p>
      ...
      <Link
        href="/settings"
        className="shrink-0 font-medium text-amber-100 underline underline-offset-2 hover:text-white"
      >
        Go to Settings
      </Link>
    </div>
