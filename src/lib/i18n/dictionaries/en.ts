...
const en = {
  ...
  dashboard: {
    ...
    completeProfileBody: "Add a bio and at least one social account so sponsors know who they're offering to.",
  ...
  analyzer: {
    ...
    ruleBasedEstimate:
      "Rule-based estimate — no AI provider could be reached, so this is arithmetic on your reach and category, not an AI reading of the offer.",
  ...
  inbox: {
    ...
    hideSpam: "Hide {count} possible spam",
    possibleSpam: "Possible spam",
    possibleSpamTitle: "Our filter flagged this as a likely notification or spam email, not a real sponsorship offer.",
    noneMatchFilter: "No deals match this filter.",
    companyIntelligence: "Company & domain intelligence",
    verifiedCompanyAccount: "Verified Green Light company account",
    verifiedCompanyAccountNote: "This offer came from a registered company account — sent and tracked entirely on-platform.",
    freeEmailWarning: "This offer came from a free consumer email address, not a company domain — worth a closer look.",
    yourHistory: "Your history with this domain",
    yourHistoryNote: "Deals so far with this domain: {count} ({agreed} agreed or paid).",
    yourHistoryDisputed: "{count} of those were disputed.",
    yourHistoryNone: "No past deals with this domain yet.",
  ...
  mediaKit: {
    ...
    nameLabel: "Name",
    editNameInSettings: "Edit your name in Settings.",
    bio: "Bio",
    bioPlaceholder: "Tell sponsors who you are and what you make…",
    country: "Country",
    primaryLanguage: "Language",
    baseRate: "Base rate (USD)",
    baseRateHint: "Your starting rate — self-reported, shown on your public profile.",
    socialAccounts: "Social accounts",
    socialAccountsNote: "Handles or links. Shown on your public profile below.",
  ...
  settings: {
    title: "Settings",
    description: "Account, email intake and notifications.",
    account: "Account",
    name: "Display name",
    email: "Email",
    role: "Role",
    ...
    whatsappNote: "Get an instant WhatsApp message the moment a new deal comes in.",
    whatsappNumber: "WhatsApp number",
    whatsappToggle: "Receive instant WhatsApp notifications for new deals",
    ...
    showSetupGuide: "How to set up forwarding",
  ...
  pricing: {
    title: "Pricing & plans",
    description: "Compare plans and manage your subscription over Discord.",
    mena: "MENA",
    international: "International",
    perMonth: "/mo",
    commission: "{pct} commission",
    current: "Current plan",
    manageOnDiscord: "Manage via Discord",
    starterName: "Starter",
    starterFeatures: "5 email analyses/mo · 2 platform connections · Basic chat",
    proName: "Pro Creator",
    proFeatures:
      "Unlimited analysis · All platforms + Twitch/Kick live · Fraud detector · Verified audience geo (YouTube/Instagram)",
    eliteName: "Elite / Agency",
    eliteFeatures: "Manage up to 5 accounts · Media Kit PDF export · VIP support · Verified audience geo included",
    companiesNote: "Companies browse and contact creators for free — commission is charged on the deal, not on company seats.",
    redeemTitle: "Have a promo code?",
    promoCodeLabel: "Enter your code",
