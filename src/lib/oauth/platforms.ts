 ...
 *
 * Distinct from the §7.3 Analytics OAuth flow (YouTube/Instagram, gated by
 ...
 * client ID + secret — X and TikTok and Meta aren't even in the `Platform`
 * enum, and Twitch already has real self-reported-stats support unrelated
 * to this, so none of this touches that schema.
 */
export const OAUTH_PLACEHOLDER_PLATFORMS = ["x", "tiktok", "meta", "twitch"] as const;
